...
% попытаться сделать сортировку в алфавитном порядке

\begin{tikzpicture}
  [
    auto,
    block/.style = {rectangle, draw=blue, thick, fill=blue!20, text width = 4.5em,
...
\begin{tikzpicture}
  [
    ...
    cloud/.style = {ellipse, draw=blue, thick, fill=blue!20,
                    minimum height = 2em},
    line/.style  = {draw, thick, -latex', shorten >= 2pt}
  ]
